...
void main() {
  group('Admin Analytics Widget Tests', () {
    ...
    testWidgets(
      'Analytics page loads and displays title',
    ...
    // Test 2: Membership chart renders
    testWidgets(
      'Membership line chart displays when data exists',
      (WidgetTester tester) async {
    ...
    // Test 3: Event names display
    testWidgets(
      'Event attendance bar chart displays event names',
      (WidgetTester tester) async {
    ...
    // Test 4: Live member count
    testWidgets(
      'Live member count shows correct number',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Shows empty state message when no event attendance data',
      (WidgetTester tester) async {
    ...
    // Test 6: Loading indicator appears
    testWidgets(
    ...
    // Test 7: Loading indicator disappears
    testWidgets(
    ...
    // Test 8: Export PDF button exists
    testWidgets(
      'Export PDF button is displayed on page',
      (WidgetTester tester) async {
    ...
    // Test 9: 1W button
    testWidgets(
      'Week period button (1W) is displayed',
      (WidgetTester tester) async {
    ...
    // Test 10: 1M button
    testWidgets(
      'Month period button (1M) is displayed',
      (WidgetTester tester) async {
    ...
    // Test 11: 6M button
    testWidgets(
      '6 months period button (6M) is displayed',
      (WidgetTester tester) async {
    ...
    // Test 12: 1Y button
    testWidgets(
      'Year period button (1Y) is displayed',
      (WidgetTester tester) async {
    ...
    testWidgets(
      'Event list loads multiple events',
      (WidgetTester tester) async {
