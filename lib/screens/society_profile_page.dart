                      ...
                      : SizedBox(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final int? capacityLimit = event["capacity_limit"];
                              final int currentAttendees = event["attendee_count"] ?? 0;
                              final bool isFull = capacityLimit != null && currentAttendees >= capacityLimit;
                                            ...
                                            children: [
                                              ...
                                              if (!widget.isAdmin && !isPast)
                                                SizedBox(
                                                  width: double.infinity,
                                                  child: ElevatedButton(
                                                    onPressed: isFull ? null : () => toggleEventAttendance(event["id"]),
                                                    style: ElevatedButton.styleFrom(
                                                      backgroundColor: isAttending
                                                          ? const Color(0xFFEF4444)
                                                          : (isFull ? Colors.grey : const Color(0xFF10B981)),
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          isAttending ? "Leave Event" : (isFull ? "Event Full" : "Attend Event"),
                                                          style: const TextStyle(
                                                            color: Colors.white,
                                                            fontSize: 14,
                                                            fontWeight: FontWeight.w600,
